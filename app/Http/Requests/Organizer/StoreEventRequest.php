...
/**
 * Sem `status`: a primeira edição sempre nasce Publicada -- Rascunho filtra
 * fora de `Event::current()` (App\Models\Event::scopePublic), que é o que
 * toda tela do organizador usa pra saber "qual evento estou configurando"
 * (ver ResolvesParticipation::currentEventOrFail). Criar em Rascunho
 * autobloquearia o organizador de qualquer tela administrativa até alguém
 * lembrar de publicar.
 */
