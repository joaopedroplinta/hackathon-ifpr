...
/**
 * SVG inline de propósito: sem requisição externa, funciona offline e não
 * depende da rede do evento.
 */
function GoogleLogo() {
    return (
...
export function GoogleLoginButton({ label = 'Entrar com Google' }: { label?: string }) {
    return (
        <Button variant="outline" className="w-full" asChild>
            {/* Link normal, não <Link> do Inertia: o redirect sai do nosso domínio. */}
